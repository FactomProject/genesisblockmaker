#taken from https://github.com/vbuterin/pybitcointools/blob/master/bitcoin/bci.py
#must be used with the python bitcoin package 'bitcoin' which is MIT liscensed
